...
const STRINGS = {
  ...
  ja: {
    ...
    wall_alone: '他の博物学者の投稿はまだない。しばし記録室は汝のもの。',
    wall_back: '戻る',
    scope_my: '私の図版',
    scope_all: '全図版',
    on_file: '登録',
  ...
  ko: {
    ...
    wall_alone: '아직 다른 박물학자의 투고가 없다. 잠시 기록실은 그대의 것이다.',
    wall_back: '돌아가다',
    scope_my: '내 도판',
    scope_all: '모든 도판',
    on_file: '등록',
  ...
  es: {
    ...
    cta_share_again: 'Compartir otra vez',
    ...
    discard_plate: 'Descartar este ejemplar',
    discard_confirm: 'Toque otra vez para confirmar',
    discard_yes: 'Descartar',
    discard_cancel: 'Conservar',
    ...
    wall_alone: 'Ningún otro naturalista ha contribuido aún. Por un momento, el archivo es suyo.',
    wall_back: 'Volver',

import type { PetFilterCartridge, PetSpeciesPack } from './types';

// Pet catalog + img2img prompts. Subject-agnostic prompt pattern: we describe
// the TARGET species + scene + style; the platform's img2img uses the user's
// uploaded ref as the visual condition, morphing the subject's features into
// the pet form while keeping recognizable expression, eye placement, and pose
// hints. See feedback_img2img_subject_agnostic_prompt.md.
export function createNaturalistSpeciesPack(
...
const species: PetSpeciesPack['species'] = [
  // ─── Everyday ───
  {
    id: 'cat',
    name: 'House Cat',
